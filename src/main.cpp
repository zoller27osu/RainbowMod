...
Array<Il2CppObject*>* GetAllObjectsOfType(std::string_view nameSpace, std::string_view klassName) {
    ...
    il2cpp_utils::RunMethod(
        &objects, "UnityEngine", "Resources", "FindObjectsOfTypeAll", il2cpp_utils::GetSystemType(nameSpace, klassName));
    return objects;
}
...
Il2CppObject* CreateColorSO() {
    ...
    il2cpp_utils::RunMethod(
        &simpleColorSO, "UnityEngine", "ScriptableObject", "CreateInstance", il2cpp_utils::GetSystemType("", "SimpleColorSO"));
...
void CacheSaberMaterials(Il2CppObject* saber) {
    ...
    il2cpp_utils::RunMethod(
        &childTransforms, saber, "GetComponentsInChildren", il2cpp_utils::GetSystemType("UnityEngine", "Transform"), false);
    for (int i = 0; i < childTransforms->Length(); i++) {
        Array<Il2CppObject*>* renderers;
        il2cpp_utils::RunMethod(&renderers, childTransforms->values[i], "GetComponentsInChildren",
            il2cpp_utils::GetSystemType("UnityEngine", "Renderer"), false);
    ...
    if (colorManagers != nullptr) {
        if (isInTutorial) {
            ...
            for (int i = 0; i < colorManagers->Length(); i++) {
                ...
                if (colorsDidChangeEvent != nullptr) il2cpp_utils::RunMethod(colorsDidChangeEvent, "Invoke");
            }
...
MAKE_HOOK_OFFSETLESS(GameNoteController_Update, void, Il2CppObject* self) {
    if (Config.Notes) {
        ...
        Array<Il2CppObject*>* materialPropertyBlockControllers = reinterpret_cast<Array<Il2CppObject*>*>(
            il2cpp_utils::GetFieldValue(colorNoteVisuals, "_materialPropertyBlockControllers"));
        ...
        for (int i = 0; i < materialPropertyBlockControllers->Length(); i++) {
            ...
            il2cpp_utils::RunMethod(
                materialPropertyBlock, "SetColor", il2cpp_utils::createcsstr("_Color"), materialPropertyBlockColor);
...
extern "C" void load() {
    ...
    INSTALL_HOOK_OFFSETLESS(
        TutorialController_OnDestroy, il2cpp_utils::FindMethodUnsafe("", "TutorialController", "OnDestroy", 0));
    INSTALL_HOOK_OFFSETLESS(
        ColorManager_ColorForNoteType, il2cpp_utils::FindMethodUnsafe("", "ColorManager", "ColorForNoteType", 1));
    INSTALL_HOOK_OFFSETLESS(
        ColorManager_ColorForSaberType, il2cpp_utils::FindMethodUnsafe("", "ColorManager", "ColorForSaberType", 1));
    INSTALL_HOOK_OFFSETLESS(
        ColorManager_EffectsColorForSaberType, il2cpp_utils::FindMethodUnsafe("", "ColorManager", "EffectsColorForSaberType", 1));
    INSTALL_HOOK_OFFSETLESS(
        ColorManager_GetObstacleEffectColor, il2cpp_utils::FindMethodUnsafe("", "ColorManager", "GetObstacleEffectColor", 0));
